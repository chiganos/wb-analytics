...
@app.get("/api/analytics/price-metric-summary/{article}", response_class=HTMLResponse)
def price_metric_summary_analysis(article: int):
    html = price_metric_summary.render_price_metric_summary(article, DB_PATH)
    return html
